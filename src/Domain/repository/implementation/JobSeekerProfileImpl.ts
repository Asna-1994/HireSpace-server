...
export class JobSeekerProfileImpl implements JobSeekerProfileRepository {
  ...
  async update(jobSeekerProfile: Partial<JobSeekerProfile>): Promise<JobSeekerProfile> {
  ...
  async findOneAndUpdate(filter : object , update : object, options : object): Promise<JobSeekerProfile> {
    const jobSeekerProfile = await JobSeekerProfileModel.findOneAndUpdate(filter , update , options)
