...
export interface JobSeekerProfileRepository {
  ...
  update(jobSeekerProfile: Partial<JobSeekerProfile>): Promise<JobSeekerProfile>;
  create(jobSeekerProfile: Partial<JobSeekerProfile>,  options?: { session?: mongoose.ClientSession } ): Promise<JobSeekerProfile> 
    ...
    findOneAndUpdate(filter : object , update : object , options : object) : Promise<JobSeekerProfile>;
}
