...
export interface JobPostRepository {
  findOne(companyId: string): Promise<JobPost | null>;
   findPostsWithPagination(offset : number , limit : number, filter : object): Promise<JobPost[] | []>;
  ...
  findById(jobPostId: string): Promise<JobPost | null>;
    ...
    findOneAndUpdate(filter : object , update : object , options : object) : Promise<JobPost  | null>;
    findByIdAndUpdate(jobPostId: string , update : object , options : object) : Promise<JobPost  | null>;
