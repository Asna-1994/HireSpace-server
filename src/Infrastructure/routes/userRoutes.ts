...
router.post("/google/callback", (req, res, next) =>
  googleSigInController.googleSignIn(req, res, next),
);
...
router.patch(
  ...
  (req, res, next) =>
    uploadProfilePhotoController.uploadProfilePicture(req, res, next),
);
router.patch(
  ...
  validateRequest,
  (req: Request, res: Response, next: NextFunction) =>
    uploadProfilePhotoController.editBasicDetails(req, res, next),
);
router.patch(
  ...
  validateRequest,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.addEducation(req, res, next),
);
router.get(
  "/:userId/all-education",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.getAllEducation(req, res, next),
);
router.delete(
  "/:userId/education/:educationId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.deleteEducation(req, res, next),
);
router.get(
  "/:userId/complete-profile",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.getJobSeekerProfile(req, res, next),
);
//job seeker profile
router.patch(
  ...
  (req, res, next) => uploadProfilePhotoController.uploadResume(req, res, next),
);
router.get("/get-resume/:userId", checkIfAUthenticated, (req, res, next) =>
  uploadProfilePhotoController.getResume(req, res, next),
);
router.patch("/delete-resume/:userId", checkIfAUthenticated, (req, res, next) =>
  uploadProfilePhotoController.deleteResume(req, res, next),
);
router.delete(
  "/delete-profile-image/:userId",
  checkIfAUthenticated,
  (req, res, next) =>
    uploadProfilePhotoController.deleteProfilePicture(req, res, next),
);
router.patch(
  ...
  validateRequest,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.addWorkExperience(req, res, next),
);
router.patch(
  "/add-or-update-skills/:userId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.addSkills(req, res, next),
);
router.get(
  "/:userId/all-experience",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.getAllExperience(req, res, next),
);
router.delete(
  "/:userId/experience/:experienceId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.deleteExperience(req, res, next),
);
router.get(
  "/:userId/all-skills",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.getAllSkills(req, res, next),
);
router.get(
  "/:userId/all-certificates",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.getAllCertificates(req, res, next),
);
router.delete(
  "/:userId/delete-skills",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.deleteSkill(req, res, next),
);
router.patch(
  "/add-or-update-certificates/:userId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.addOrEditCertificates(req, res, next),
);
router.patch(
  "/profile-tag-line/:userId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.addTagline(req, res, next),
);
router.delete(
  "/:userId/certificates/:certificateId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.deleteCertificate(req, res, next),
);
...
router.get(
  ...
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    userJobPostController.getAllJobPostForUser(req, res, next),
);
router.get(
  "/all-saved-job-posts/:userId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    userJobPostController.getSavedJobPosts(req, res, next),
);
router.patch(
  "/save-job-post/:userId/:jobPostId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    manageJobSeekerProfileController.saveJob(req, res, next),
);
router.post(
  "/report-spam",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    userJobPostController.reportSpam(req, res, next),
);
...
router.post(
  ...
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    userJobApplicationController.applyForJob(req, res, next),
);
router.get(
  "/all-job-applications/:userId",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    userJobApplicationController.getAllJobApplicationForUser(req, res, next),
);
router.get(
  "/:userId/statics",
  checkIfAUthenticated,
  (req: Request, res: Response, next: NextFunction) =>
    userJobApplicationController.getHomeStatsForUser(req, res, next),
);
