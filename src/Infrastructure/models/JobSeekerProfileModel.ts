...
import { Certificates, EducationObject, ExperienceObject, Skills } from '../../Domain/entities/JobSeekerProfile';
...
export const JobSeekerProfileModel = model<JobSeekerProfileDocument>('JobSeekerProfileModel', jobSeekerProfileSchema);
