...
const subscriptionsUseCase = new SubscriptionsUseCase(subscriptionRepo, userRepo);
...
export const scheduleSubscriptionJobs = () => {
  cron.schedule('0 0 * * *', async () => {
    ...
    throw new CustomError(STATUS_CODES.INTERNAL_SERVER_ERROR,"Error in scheduling job")
    }
  });
};
